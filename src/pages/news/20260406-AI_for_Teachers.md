...
tags:
  - 教師のためのAI入門
  - AI for Teachers&colon; an Open Textbook
  - 名古屋大学
---
...
- [教師のためのAI入門（AI for Teachers: an Open Textbook）サポートページ](https://yamazato.nuee.nagoya-u.ac.jp/research/OER/AI_for_Teachers_an_Open_Textbook/)

本書はCC BY 4.0のもとで公開されています。
適切な出典表示を行うことで、複製、配布、転載、改変、再利用を自由に行うことができます。
